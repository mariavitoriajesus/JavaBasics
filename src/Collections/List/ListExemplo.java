...
public class ListExemplo {
    public static void main(String[] args) {
        //List<Double> notas = new ArrayList<>(); não e recomendada, pois devemos fazer voltada
                                                // para a interface e não para a implementação.
        ...
        notas.add(4, 8d);// adicionar um elemento
        System.out.println(notas);

        System.out.println("\n Substitua a nota 5 pela nota 6: ");
        notas.set(notas.indexOf(5d), 6.0); // metodo de substituição
        System.out.println(notas);

        System.out.println("\n Confira se a nota 5 está na lista: "+ notas.contains(5d));
        ...
        Graças ao Iterator, os clientes podem examinar elementos de diferentes coleções de maneira
        semelhante usando uma única interface iterador.
         */
